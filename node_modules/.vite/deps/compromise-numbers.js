...
// node_modules/compromise-numbers/builds/compromise-numbers.mjs
var e = function(e2, n2) {
  ...
  }), "number" == typeof n2 && (t2 = t2.get(n2)), t2;
};
var n = "twenty|thirty|forty|fifty|sixty|seventy|eighty|ninety|fourty";
var t = function(e2, t2) {
  ...
  return r2.has("#NumberRange") && (r2 = r2.splitAfter("#NumberRange")), "number" == typeof t2 && (r2 = r2.get(t2)), r2;
};
var r = function(e2, n2) {
  let t2 = e2.match("#Fraction+");
  return t2 = t2.filter((e3) => !e3.lookBehind("#Value and$").found), "number" == typeof n2 && (t2 = t2.eq(n2)), t2;
};
var a = function(e2, n2) {
  let t2 = e2.match("#Percent+");
  return t2 = t2.concat(e2.match("[#Cardinal] percent", 0)), "number" == typeof n2 && (t2 = t2.eq(n2)), t2;
};
...
var u = (e2) => {
  ...
  for (let t2 = 0; t2 < n2.length; t2++) if (true === n2[t2].reg.test(e2)) return { amount: n2[t2].mult, str: e2.replace(n2[t2].reg, "") };
  return { amount: 1, str: e2 };
};
var l = i;
var m = (e2, n2) => {
  if (s.ones.hasOwnProperty(e2)) {
    if (n2.ones || n2.teens) return false;
  } else if (s.teens.hasOwnProperty(e2)) {
    if (n2.ones || n2.teens || n2.tens) return false;
  } else if (s.tens.hasOwnProperty(e2) && (n2.ones || n2.teens || n2.tens)) return false;
  return true;
};
var c = function(e2) {
  let n2 = "0.";
  for (let t2 = 0; t2 < e2.length; t2++) {
    let r2 = e2[t2];
    if (true === o.ones.hasOwnProperty(r2)) n2 += o.ones[r2];
    else if (true === o.teens.hasOwnProperty(r2)) n2 += o.teens[r2];
    else if (true === o.tens.hasOwnProperty(r2)) n2 += o.tens[r2];
    else {
...
var h = (e2) => e2 = (e2 = (e2 = (e2 = (e2 = (e2 = (e2 = (e2 = e2.replace(/1st$/, "1")).replace(/2nd$/, "2")).replace(/3rd$/, "3")).replace(/([4567890])r?th$/, "$1")).replace(/^[$€¥£¢]/, "")).replace(/[%$€¥£¢]$/, "")).replace(/,/g, "")).replace(/([0-9])([a-z\u00C0-\u00FF]{1,2})$/, "$1");
var f = /^([0-9,\. ]+)\/([0-9,\. ]+)$/;
var d = { "a few": 3, "a couple": 2, "a dozen": 12, "two dozen": 24, zero: 0 };
var y = (e2) => Object.keys(e2).reduce((n2, t2) => n2 += e2[t2], 0);
var p = function(e2) {
  if (true === d.hasOwnProperty(e2)) return d[e2];
  ...
  for (let e3 = 0; e3 < s2.length; e3++) {
    let o2 = s2[e3];
    if (o2 = h(o2), !o2 || "and" === o2) continue;
    if ("-" === o2 || "negative" === o2) {
      i2 = true;
      continue;
    }
    if ("-" === o2.charAt(0) && (i2 = true, o2 = o2.substr(1)), "point" === o2) return a2 += y(r2), a2 += c(s2.slice(e3 + 1, s2.length)), a2 *= n2.amount, a2;
    const u2 = o2.match(f);
    if (u2) {
      const e4 = parseFloat(u2[1].replace(/[, ]/g, "")), n3 = parseFloat(u2[2].replace(/[, ]/g, ""));
      n3 && (a2 += e4 / n3 || 0);
    } else {
      if (l.tens.hasOwnProperty(o2) && r2.ones && 1 === Object.keys(r2).length && (a2 = 100 * r2.ones, r2 = {}), false === m(o2, r2)) return null;
      if (/^[0-9\.]+$/.test(o2)) r2.ones = parseFloat(o2);
      else if (true === l.ones.hasOwnProperty(o2)) r2.ones = l.ones[o2];
      else if (true === l.teens.hasOwnProperty(o2)) r2.teens = l.teens[o2];
      else if (true === l.tens.hasOwnProperty(o2)) r2.tens = l.tens[o2];
      else if (true === l.multiples.hasOwnProperty(o2)) {
        let n3 = l.multiples[o2];
        if (n3 === t2) return null;
        if (100 === n3 && void 0 !== s2[e3 + 1]) {
          const t3 = s2[e3 + 1];
          l.multiples[t3] && (n3 *= l.multiples[t3], e3 += 1);
        }
        null === t2 || n3 < t2 ? (a2 += (y(r2) || 1) * n3, t2 = n3, r2 = {}) : (a2 += y(r2), t2 = n3, a2 = (a2 || 1) * n3, r2 = {});
      }
    }
  }
  return a2 += y(r2), a2 *= n2.amount, a2 *= i2 ? -1 : 1, 0 === a2 && 0 === Object.keys(r2).length ? null : a2;
};
var b = /s$/;
var g = p;
var x = function(e2) {
...
var v = function(e2) {
  let n2 = function(e3) {
    ...
    if (true !== n3.found) return null;
    let { num: t2, den: r2 } = n3.groups();
    return t2 && r2 ? (t2 = x(t2), r2 = x(r2), "number" == typeof t2 && "number" == typeof r2 ? { numerator: t2, denominator: r2 } : null) : null;
  }(e2) || function(e3) {
    ...
    return b.test(a2) && (a2 = a2.replace(b, ""), r2.replaceWith(a2)), r2 = $.hasOwnProperty(a2) ? $[a2] : x(r2), "number" == typeof t2 && "number" == typeof r2 ? { numerator: t2, denominator: r2 } : null;
  }(e2) || function(e3) {
    let n3 = e3.match("^#Ordinal$");
    if (true !== n3.found) return null;
    if (e3.lookAhead("^of .")) return { numerator: 1, denominator: x(n3) };
    return null;
  }(e2) || null;
  return null !== n2 && n2.numerator && n2.denominator && (n2.decimal = n2.numerator / n2.denominator, n2.decimal = ((e3) => {
    let n3 = Math.round(1e3 * e3) / 1e3;
    return 0 === n3 && 0 !== e3 ? e3 : n3;
  })(n2.decimal)), n2;
};
var w = p;
var k = v;
var C = function(e2) {
  let n2 = e2.text("reduced"), t2 = /[0-9],[0-9]/.test(e2.text("text")), r2 = function(e3, n3, t3) {
    ...
    if (r3 && r3[2] && n3.terms().length < 2) {
      ...
      "number" != typeof n4 && (n4 = null);
      let a3 = r3[3] || "";
      return "st" !== a3 && "nd" !== a3 && "rd" !== a3 && "th" !== a3 || (a3 = ""), "m" !== a3 && "M" !== a3 || (n4 *= 1e6, a3 = ""), "k" !== a3 && "k" !== a3 || (n4 *= 1e3, a3 = ""), n4 = t3 ? 1 / n4 : n4, { prefix: r3[1] || "", num: n4, suffix: a3 };
    }
    return null;
  }(n2, e2);
  if (null !== r2) return r2.hasComma = t2, r2;
  let a2 = e2.match("#Fraction #Fraction+$");
  a2 = false === a2.found ? e2.match("^#Fraction$") : a2;
  let i2 = null;
...
var O = function(e2) {
  ...
  let n2;
  return n2 = "number" == typeof e2 ? e2.toFixed(0) : e2, -1 === n2.indexOf("e+") ? n2 : n2.replace(".", "").split("e+").reduce(function(e3, n3) {
    return e3 + Array(n3 - e3.length + 2).join(0);
  });
};
var V = O;
var F = [["ninety", 90], ["eighty", 80], ["seventy", 70], ["sixty", 60], ["fifty", 50], ["forty", 40], ["thirty", 30], ["twenty", 20]];
var M = ["", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine", "ten", "eleven", "twelve", "thirteen", "fourteen", "fifteen", "sixteen", "seventeen", "eighteen", "nineteen"];
var E = [[1e24, "septillion"], [1e20, "hundred sextillion"], [1e21, "sextillion"], [1e20, "hundred quintillion"], [1e18, "quintillion"], [1e17, "hundred quadrillion"], [1e15, "quadrillion"], [1e14, "hundred trillion"], [1e12, "trillion"], [1e11, "hundred billion"], [1e9, "billion"], [1e8, "hundred million"], [1e6, "million"], [1e5, "hundred thousand"], [1e3, "thousand"], [100, "hundred"], [1, "one"]];
var N = function(e2) {
  let n2 = [];
  if (e2 > 100) return n2;
  for (let t2 = 0; t2 < F.length; t2++) e2 >= F[t2][1] && (e2 -= F[t2][1], n2.push(F[t2][0]));
  return M[e2] && n2.push(M[e2]), n2;
};
var P = function(e2) {
  if (0 === e2 || "0" === e2) return "zero";
  e2 > 1e21 && (e2 = V(e2));
  let n2 = [];
  ...
  for (let e3 = 0; e3 < t2.length; e3++) {
    let r2 = t2[e3].unit;
    "one" === r2 && (r2 = "", n2.length > 1 && n2.push("and")), n2 = n2.concat(N(t2[e3].count)), n2.push(r2);
  }
  return n2 = n2.concat(((e3) => {
    const n3 = ["zero", "one", "two", "three", "four", "five", "six", "seven", "eight", "nine"];
    let t3 = [], r2 = V(e3).match(/\.([0-9]+)/);
    if (!r2 || !r2[0]) return t3;
    t3.push("point");
    let a2 = r2[0].split("");
    for (let e4 = 0; e4 < a2.length; e4++) t3.push(n3[a2[e4]]);
    return t3;
  })(e2)), n2 = n2.filter((e3) => e3), 0 === n2.length && (n2[0] = ""), n2.join(" ");
};
var z = O;
var A = P;
var j = { one: "first", two: "second", three: "third", five: "fifth", eight: "eighth", nine: "ninth", twelve: "twelfth", twenty: "twentieth", thirty: "thirtieth", forty: "fortieth", fourty: "fourtieth", fifty: "fiftieth", sixty: "sixtieth", seventy: "seventieth", eighty: "eightieth", ninety: "ninetieth" };
var q = (e2) => {
...
var R = P;
var L = function(e2) {
  if (!e2 && 0 !== e2) return null;
  let n2 = e2 % 100;
  if (n2 > 10 && n2 < 20) return String(e2) + "th";
...
var B = S.prefixes;
var D = S.suffixes;
var U = { usd: true, eur: true, jpy: true, gbp: true, cad: true, aud: true, chf: true, cny: true, hkd: true, nzd: true, kr: true, rub: true };
var K = function(e2) {
...
var Y = function(e2, n2, t2) {
  ...
  return n2 ? (e2 = K(e2), t2 ? (r2 = W(r2), `${e2.prefix || ""}${r2}${e2.suffix || ""}`) : (r2 = R(r2), `${e2.prefix || ""}${r2}${e2.suffix || ""}`)) : t2 ? (r2 = L(r2), `${(e2 = K(e2)).prefix || ""}${r2}${e2.suffix || ""}`) : (true === e2.hasComma && (r2 = e2.num.toLocaleString()), r2 = T(r2), `${e2.prefix || ""}${r2}${e2.suffix || ""}`);
};
var G = C;
var H = function(e2, n2, t2) {
  if (false === e2) return;
  let r2 = n2.lookAhead("^(#Unit|#Noun)");
  r2.has("(#Address|#Money|#Percent)") || n2.has("#Ordinal") || (1 === t2.num ? r2.nouns().toSingular() : r2.has("#Singular") && r2.nouns().toPlural());
};
var I = Y;
var Q = p;
var Z = { json: function(e2) {
  let n2 = null;
  "number" == typeof e2 && (n2 = e2, e2 = null), e2 = e2 || { text: true, normal: true, trim: true, terms: true };
  let t2 = [];
  ...
  return void 0 === e2 || ("string" == typeof e2 && (e2 = Q(e2)), this.forEach((t2) => {
    let r2 = G(t2);
    if (r2.num = e2, null === r2.num) return;
    let a2 = I(r2, t2.has("#TextValue"), t2.has("#Ordinal"));
    (t2 = t2.not("#Currency")).replaceWith(a2, true), H(n2, t2, r2);
  })), this;
}, add: function(e2, n2) {
  return e2 ? ("string" == typeof e2 && (e2 = Q(e2)), this.forEach((t2) => {
    let r2 = G(t2);
    if (null === r2.num) return;
    r2.num += e2;
    let a2 = I(r2, t2.has("#TextValue"), t2.has("#Ordinal"));
    (t2 = t2.not("#Currency")).replaceWith(a2, true), H(n2, t2, r2);
  }), this) : this;
  ...
  return "number" == typeof e2 && (n2 = n2.get(e2)), n2;
}, normalize: function() {
  const e2 = { "%": true };
  return this.forEach((n2) => {
    let t2 = G(n2);
    if (null !== t2.num && t2.suffix && true !== e2[t2.suffix]) {
      let e3 = t2.prefix || "";
...
var _ = function(e2) {
  let n2 = X(e2).num;
  return "number" == typeof n2 ? n2 / 100 : null;
};
...
var ue = function(e2) {
  ...
  let i2 = ((s2 = r2).suffix && ae.hasOwnProperty(s2.suffix) ? te.find((e3) => e3.iso === ae[s2.suffix]) : s2.prefix && ae.hasOwnProperty(s2.prefix) ? te.find((e3) => e3.iso === ae[s2.prefix]) : null) || function(e3) {
    ...
    return te.find((e4) => (t3 === `${e4.dem} ${e4.name}` || t3 === e4.iso || t3 === e4.sub || t3 === e4.name || !(!e4.alias || true !== e4.alias[t3])) && e4);
  }(e2) || {};
  var s2;
  let o2 = "";
...
var me = { get: function(e2) {
  ...
  return this.forEach((e3) => {
    let t2 = ue(e3);
    t2 && n2.push(t2);
  }), "number" == typeof e2 ? n2[e2] || null : n2 || null;
}, json: function(e2) {
  let n2 = null;
  "number" == typeof e2 && (n2 = e2, e2 = null), e2 = e2 || { text: true, normal: true, trim: true, terms: true };
  let t2 = [];
  return this.forEach((n3) => {
    ...
    if (r2.number = a2.num, a2.iso && (r2.iso = a2.iso.toUpperCase(), r2.symbol = a2.symbol, r2.currency = le(a2.demonym) + " " + le(a2.currency)), r2.textFmt = oe(a2, true, false), a2.currency) {
      let e3 = a2.currency;
      1 !== a2.num && (e3 = a2.plural || e3 + "s"), r2.textFmt += " " + e3;
    }
    t2.push(r2);
  }), null !== n2 ? t2[n2] || {} : t2;
} };
...
ce.toText = function(e2) {
  ...
  return 2 === e2.denominator && (t2 = "half"), n2 && t2 ? (1 !== e2.numerator && (t2 += "s"), `${n2} ${t2}`) : "";
...
var pe = { get: function(e2) {
  ...
  return this.forEach((e2) => {
    let n2 = de(e2);
    if (n2 && "number" == typeof n2.numerator && "number" == typeof n2.denominator) {
...
var ve = { mark: true, sucre: true, leone: true, afghani: true, rand: true, try: true, mop: true, won: true, all: true, rub: true, eek: true, sit: true, bam: true, npr: true, leu: true };
var we = { kronor: "Currency" };
ne.forEach((e2) => {
...
var Ne = be;
var Pe = $e;
var ze = { Fraction: { isA: ["Value"] }, Multiple: { isA: "Value" } };
var Ae = we;
...
var compromise_numbers_default = je;
export {
  compromise_numbers_default as default
};
